...
provider "aws" {
  ...
  access_key = data.infisical_secrets.sulfoxide_tofu.secrets["AWS_ACCESS_KEY"].value
  secret_key = data.infisical_secrets.sulfoxide_tofu.secrets["AWS_SECRET_KEY"].value
}
